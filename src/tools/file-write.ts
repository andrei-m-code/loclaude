...
const inputSchema = z.object({
  file_path: z.string().describe("Path to the file to write (absolute or relative to workspace)"),
...
export class FileWriteTool extends BaseTool<FileWriteInput> {
  ...
  readonly description =
    "Create or overwrite a file with the given content. Paths can be absolute or relative to the workspace. Parent directories are created automatically.";
